...
const TutorLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 transform bg-secondary-900 transition duration-300 ease-in-out md:relative md:translate-x-0 ${
          sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        <div className="flex h-16 items-center justify-between px-4">
          <div className="text-white font-bold text-xl">Tutor Dashboard</div>
          <button
            type="button"
