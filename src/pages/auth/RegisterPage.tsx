  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      ...
      if (isGoogleAuth && googleToken) {
        ...
        toast.success('Welcome aboard! Your registration is complete.');
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-8">
          ...
          <div className="text-center max-w-md">
            <h1 className="text-3xl font-bold mb-3">Join VerifiedTutors</h1>
            <p className="text-base text-blue-100 leading-relaxed">
              Start your journey as a student seeking knowledge or a tutor
              sharing expertise. Create your account and unlock endless learning
              possibilities.
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 max-w-md">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-blue-100">
                Find qualified tutors or become one
              </span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
