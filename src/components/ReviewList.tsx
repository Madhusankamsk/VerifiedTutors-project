      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <div className="flex items-center mt-1">
            <Rating rating={averageRating || 0} readOnly />
            <span className="ml-2 text-gray-600">
              {averageRating ? averageRating.toFixed(1) : '0.0'} ({totalReviews || 0} reviews)
            </span>
          </div>
        </div>
      </div>
      ...
      {reviews && reviews.length > 0 ? (
        <div className="space-y-6">
          {reviews.map((review) => {
            ...
            const commentPreview = review.comment && review.comment.length > 150 && !isReviewExpanded
              ...
              <div key={review.id} className="border-b border-gray-100 pb-6 last:border-0 last:pb-0">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-100 flex-shrink-0">
                    ...
                    <div className={`w-full h-full flex items-center justify-center bg-blue-100 ${review.user?.profileImage ? 'hidden' : ''}`}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-1">
                      <Rating rating={review.rating || 0} readOnly size="sm" />
                    </div>
                    <div className="mt-2">
