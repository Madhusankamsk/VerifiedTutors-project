          ...
          <div className="flex flex-wrap gap-2">
            {profile.teachingMediums.map((medium) => {
              ...
              return (
                <div
                  key={medium}
                  className="inline-flex items-center px-3 py-1.5 rounded-full bg-gray-100/80 backdrop-blur-sm text-gray-700 text-xs sm:text-sm border border-gray-200"
                >
      ...
      <div className="bg-white/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="flex flex-wrap gap-2">
          {profile.availableLocations ? (
            <span className="px-3 py-1.5 bg-gray-100/80 backdrop-blur-sm text-gray-700 rounded-full text-xs sm:text-sm border border-gray-200">
              {profile.availableLocations}
            </span>
          ) : (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {profile.socialMedia.instagram && (
              <a
                ...
                className="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50/80 backdrop-blur-sm transition-all duration-200 hover:shadow-sm"
              >
